...
(function() {
  ...
  ReparsedBracketup = (function() {
    function ReparsedBracketup() {
      this.lines = [];
      this.depth = 0;
    }

    return ReparsedBracketup;
  ...
  NodeParser = (function() {
    ...
    NodeParser.prototype.recordStart = function(token) {
      return {};
    };

    NodeParser.prototype.recordEnd = function(token) {
      return {};
    };

    NodeParser.prototype.recordQuotedCharacter = function(token) {
      return {};
    };

    NodeParser.prototype.recordText = function(token) {
      return {};
    };
